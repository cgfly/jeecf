...
public class ReflectionUtils {
    ...
    public static Object invokeGetter(Object obj, String propertyName) {
        Object object = obj;
        for (String name : StringUtils.split(propertyName, SplitCharEnum.DOT.getName())) {
    ...
    public static void invokeSetter(Object obj, String propertyName, Object value) {
        Object object = obj;
        String[] names = StringUtils.split(propertyName, SplitCharEnum.DOT.getName());
    ...
    public static void setFieldValue(final Object obj, final String fieldName, final Object value) {
        ...
        try {
            ...
            log.error("不可能抛出的异常{}", ExceptionUtils.getStackTrace(e));
        }
    }
     ...
     * 直接设置对象属性值, 无视private/protected修饰符, 不经过setter函数.
     */
    public static void setFieldValue(Field field, final Object obj, final Object value) {
        if (field == null) {
