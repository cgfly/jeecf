...
public class TableBuilder {
	...
	private static GenTableService genTableService = SpringContextUtils.getBean("genTableService",
			GenTableService.class);
	
	private static GenTableFacade genTableFacade = SpringContextUtils.getBean("genTableFacade",
