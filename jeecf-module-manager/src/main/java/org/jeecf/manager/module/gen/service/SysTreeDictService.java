 ...
 */
@Service
public class SysTreeDictService extends
		AbstractTreeNamespaceAuthService<SysTreeDictDao, SysTreeDictPO, SysTreeDictResult, SysTreeDictQuery, SysTreeDict> {
	...
	public Response<List<SysTreeDictResult>> findChilds(String id) {
		...
		Response<List<SysTreeDictResult>> sysTreeDictRes = super.findListByAuth(new SysTreeDictPO(querySysTreeDict));
	...
	public Response<List<SysTreeDictResult>> getTreeData(SysTreeDictPO sysTreeDictPO, boolean isRoot) {
		...
		Response<List<SysTreeDictResult>> sysTreeDictRes = this.findListByAuth(sysTreeDictPO);
