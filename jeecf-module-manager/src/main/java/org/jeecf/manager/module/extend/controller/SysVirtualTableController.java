...
public class SysVirtualTableController
	...
	public Response<List<SysVirtualTableColumnResult>> column(
	...
	public Response<Integer> createTable(@PathVariable("id") String id) {
		...
		if (tableRes.getData() != null) {
			...
			CreateTable createTable = CreateTable.builder().setTableName(table.getName()).setComment(table.getComment())
					.addCreateTableColumns(createTableColumns).build();
