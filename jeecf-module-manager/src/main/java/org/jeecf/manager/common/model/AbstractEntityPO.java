            ...
            for (Sort tempSort : sortList) {
                ...
                if (StringUtils.isNotEmpty(columnName)) {
                    ...
                    for (String name : columnNames) {
                        tempSort.setColumnName(JniValidate
                                .columnValidate(tableName + "." + HumpUtils.humpToLine2(name).toLowerCase()));
                    }
                }
            }
        }
    ...
    public void buildContains(String tableName) {
        ...
        if (CollectionUtils.isNotEmpty(containList)) {
            for (Contain tempContain : containList) {
                ...
                if (StringUtils.isNotEmpty(columnName)) {
                    tempContain.setColumnName(JniValidate
                            .columnValidate(tableName + "." + HumpUtils.humpToLine2(columnName).toLowerCase()));
                }
            }
        }
    }
